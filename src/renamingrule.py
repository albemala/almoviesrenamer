...
class RenamingRuleDialog(QDialog):
    ...
    RUNTIMES = 5
    LANGUAGE = 6
    OPENED_ROUND_BRACKET = 7
    CLOSED_ROUND_BRACKET = 8
    OPENED_SQUARE_BRACKET = 9
    CLOSED_SQUARE_BRACKET = 10
    OPENED_CURLY_BRACKET = 11
    CLOSED_CURLY_BRACKET = 12
    ...
    RULES_KEY_INDEX = {
        Movie.TITLE:TITLE,
        Movie.CANONICAL_TITLE:CANONICAL_TITLE,
        Movie.AKAS:AKAS,
        Movie.YEAR:YEAR,
        Movie.DIRECTOR:DIRECTOR,
        Movie.RUNTIMES:RUNTIMES,
    ...
    RULES_KEY_TEXT = {
        Movie.TITLE:"Title",
        Movie.CANONICAL_TITLE:"Canonical title",
        Movie.AKAS:"AKA",
        Movie.YEAR:"Year",
        Movie.DIRECTOR:"Director",
        Movie.RUNTIMES:"Run Time",
        Movie.LANGUAGE:"Language",
        '(':'(',
        ')':')',
        '[':'[',
    ...
    RULES_TEXT_KEY = {
        "Title":Movie.TITLE,
        "Canonical title":Movie.CANONICAL_TITLE,
        "AKA":Movie.AKAS,
        "Year":Movie.YEAR,
        "Director":Movie.DIRECTOR,
        "Run Time":Movie.RUNTIMES,
